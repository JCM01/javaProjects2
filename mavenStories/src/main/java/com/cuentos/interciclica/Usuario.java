...
public class Usuario implements Serializable {
	...
	public Usuario(String correo, String apellidos, String nombre, String password, List<Cuento> cuentos) {
		super();
		this.correo = correo;
	...
	public String toString() {
		return "Usuario [correo=" + correo + ", apellidos=" + apellidos + ", nombre=" + nombre + ", password="
				+ password + "]";
	}
